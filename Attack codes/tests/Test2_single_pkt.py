...
for packet in packets:
    if goose_check(packet):                                  #and filter_packets(p, src_mac, dst_mac)
...
print(f"[+] Select the packet you want to manipulate in the range of 0 to {len(filterd_g_packets)}.")
try:
...
user_packet = filterd_g_packets[packet_no]
