...
filter_string = "ether proto 0x88B8"
GOOSE_TYPE = 0x88b8
...
parser = argparse.ArgumentParser(description='GOOSE Replay Attack.', formatter_class=less_indent_formatter, usage='python3 %(prog)s [options]')
...
mod_pdu_decode.setComponentByName('sqNum', 0)
